...
void main() {
  ...
  test('PersonIdentity roundtrips its contact link', () {
    ...
    expect(restored.contactDisplayName, 'Kim T.');
  ...
  test('mergePeople keeps the first person\'s contact link', () {
    ...
    expect(merged.contactDisplayName, 'Kim T.');
  ...
  test('mergePeople unions names and averages centroids by sample count', () {
    ...
    expect(merged.aliases, ['Kim', 'Rob', 'Robin']);
  ...
  test('mergePeople honors an explicit primary name', () {
    ...
    final merged = mergePeople([a, b], primary: 'Kim');
