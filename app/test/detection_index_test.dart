...
void main() {
  test('reconcileIdentities heals a corrupted centroid from manual faces',
    ...
    final alex = index.identities.firstWhere((i) => i.name == 'Alex');
    expect(alex.faceSamples, 5);
    expect(alex.centroid[0], closeTo(0.6, 1e-6));
    expect(alex.centroid[1], closeTo(0.8, 1e-6));
  });
}
