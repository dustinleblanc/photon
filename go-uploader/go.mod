...
replace github.com/henrybear327/Proton-API-Bridge => github.com/dustinleblanc/Proton-API-Bridge v1.0.0-photon.1

replace github.com/ProtonMail/go-proton-api => github.com/dustinleblanc/go-proton-api v0.4.1-photon.2
